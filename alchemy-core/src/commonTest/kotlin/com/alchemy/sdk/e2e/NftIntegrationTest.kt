...
import com.alchemy.sdk.shouldBeGreaterThan
import com.alchemy.sdk.shouldNotBeEqualTo
...
class NftIntegrationTest {
    ...
    private val alchemy = Alchemy.with(
        AlchemySettings(
            apiKey = "EbmpsvHn1ga1aTEA0Qz7OJQw18CBiXYR",
    ...
    fun `nfts for owner without metadata`() = runTest {
        val ownedNftsResponse = alchemy.nft.getNftsForOwner(
    ...
    fun `retrieve floor price for the collection`() = runTest {
        ...
        floorPrice.openSea::class shouldBeEqualTo FloorPrice.FloorPriceMarketplace::class
        floorPrice.looksRare::class shouldBeEqualTo FloorPrice.FloorPriceError::class
    }
