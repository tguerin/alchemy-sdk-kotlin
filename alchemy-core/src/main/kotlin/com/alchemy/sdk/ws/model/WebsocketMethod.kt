...
sealed class WebsocketMethod<R>(
    ...
    abstract suspend fun resolveAddresses(core: Core): WebsocketMethod<R>

    object Block : WebsocketMethod<BlockHead>(
        listOf("newHeads" to String.serializer()),
        BlockHead.serializer()
    ) {
        override suspend fun resolveAddresses(core: Core): WebsocketMethod<BlockHead> {
            return this
        }
    }
    ...
    data class LogFilter(
        ...
        override suspend fun resolveAddresses(core: Core): WebsocketMethod<Log> {
    ...
    data class PendingTransactions(
        ...
        override suspend fun resolveAddresses(core: Core): WebsocketMethod<PendingTransaction> = coroutineScope {
    ...
    data class Transaction(
        ...
        override suspend fun resolveAddresses(core: Core): WebsocketMethod<TransactionReceipt> {
            return this
        }
    }
    ...
    data class UnSubscribe(
        ...
        override suspend fun resolveAddresses(core: Core): WebsocketMethod<Boolean> {
            return this
        }
    }
}